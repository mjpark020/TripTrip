...
<head>
    ...
    <script>
		...
		/* 대충 관광지이름, 사진들고오는거  */
		function getAccoList(aCode, gCode, page, aName, gName, nx, ny) {
    		...
    		$.ajax({
    			...
    			url : 'http://localhost:9090/TripTrip/accolist',
    			data : {
    					areaCode: aCode,
    					sigunguCode: gCode,
    					pageNo: page
    		...
    		.done(function(xml) {
    				...
    				for(var i=1; i<=totalPage; i++){
    					pagehtml += '<a href=\"#\" onclick=\"javascript:getAccoList(';
		...
		function viewPage(contentid, mapx, mapy, title, addr1, areaCode, firstimage){
        ...
        $(function () {
    		...
    		getAccoList(<%=areaCode%>, <%=sigunguCode%>, 1, '<%=areaName%>', '', <%=nx%>, <%=ny%>);
...
<body>
        ...
        <section id="contents">
            <aside id="side">
                <nav class="nav">
                    ...
                    <ul>	
                        <li class="areaName">
							<span onclick="javascript:getAccoList(1, 0, 1, '서울', '' , 60, 127 )">서울</span>
							<ul class="submenu">
								<c:forEach var="area1" items="${area1}">
									<li><a href="javascript:getAccoList(1, ${area1.sigunguCode},1, '${area1.areaName}', '${area1.sigunguName}', ${area1.nx}, ${area1.ny})">${area1.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
						<li class="areaName">
							<span onclick="javascript:getAccoList(2, 0, 1, '인천', '' , 55, 124 )">인천</span>
							<ul class="submenu">
								<c:forEach var="area2" items="${area2}">
									<li><a href="javascript:getAccoList(2, ${area2.sigunguCode},1, '${area2.areaName}', '${area2.sigunguName}', ${area2.nx}, ${area2.ny})">${area2.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
						<li class="areaName">
							<span onclick="javascript:getAccoList(3, 0, 1, '대전', '' , 67, 100 )">대전</span>
							<ul class="submenu">
								<c:forEach var="area3" items="${area3}">
									<li><a href="javascript:getAccoList(3, ${area3.sigunguCode},1, '${area3.areaName}', '${area3.sigunguName}', ${area3.nx}, ${area3.ny})">${area3.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
						<li class="areaName">
							<span onclick="javascript:getAccoList(4, 0, 1, '대구', '' , 89, 90 )">대구</span>
							<ul class="submenu">
								<c:forEach var="area4" items="${area4}">
									<li><a href="javascript:getAccoList(4, ${area4.sigunguCode},1, '${area4.areaName}', '${area4.sigunguName}', ${area4.nx}, ${area4.ny})">${area4.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
						<li class="areaName">
							<span onclick="javascript:getAccoList(5, 0, 1, '광주', '' , 58, 74 )">광주</span>
							<ul class="submenu">
								<c:forEach var="area5" items="${area5}">
									<li><a href="javascript:getAccoList(5, ${area5.sigunguCode},1, '${area5.areaName}', '${area5.sigunguName}', ${area5.nx}, ${area5.ny})">${area5.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
						<li class="areaName">
							<span onclick="javascript:getAccoList(6, 0, 1, '부산', '' , 98, 76 )">부산</span>
							<ul class="submenu">
								<c:forEach var="area6" items="${area6}">
									<li><a href="javascript:getAccoList(6, ${area6.sigunguCode},1, '${area6.areaName}', '${area6.sigunguName}', ${area6.nx}, ${area6.ny})">${area6.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
						<li class="areaName">
							<span onclick="javascript:getAccoList(7, 0, 1, '울산', '' , 102, 84 )">울산</span>
							<ul class="submenu">
								<c:forEach var="area7" items="${area7}">
									<li><a href="javascript:getAccoList(7, ${area7.sigunguCode},1, '${area7.areaName}', '${area7.sigunguName}', ${area7.nx}, ${area7.ny})">${area7.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
						<li class="areaName">
							<span onclick="javascript:getAccoList(8, 0, 1, '세종', '' , 66, 103 )">세종</span>
							<ul class="submenu">
								<c:forEach var="area8" items="${area8}">
									<li><a href="javascript:getAccoList(8, ${area8.sigunguCode},1, '${area8.areaName}', '${area8.sigunguName}', ${area8.nx}, ${area8.ny})">${area8.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
						<li class="areaName">
							<span onclick="javascript:getAccoList(31, 0, 1, '경기도', '' , 60, 120 )">경기도</span>
							<ul class="submenu">
								<c:forEach var="area31" items="${area31}">
									<li><a href="javascript:getAccoList(31, ${area31.sigunguCode},1, '${area31.areaName}', '${area31.sigunguName}', ${area31.nx}, ${area31.ny})">${area31.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
						<li class="areaName">
							<span onclick="javascript:getAccoList(32, 0, 1, '강원도', '' , 73, 134 )">강원도</span>
							<ul class="submenu">
								<c:forEach var="area32" items="${area32}">
									<li><a href="javascript:getAccoList(32, ${area32.sigunguCode},1, '${area32.areaName}', '${area32.sigunguName}', ${area32.nx}, ${area32.ny})">${area32.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
						<li class="areaName">
							<span onclick="javascript:getAccoList(33, 0, 1, '충청북도', '' , 69, 107 )">충청북도</span>
							<ul class="submenu">
								<c:forEach var="area33" items="${area33}">
									<li><a href="javascript:getAccoList(33, ${area33.sigunguCode},1, '${area33.areaName}', '${area33.sigunguName}', ${area33.nx}, ${area33.ny})">${area33.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
						<li class="areaName">
							<span onclick="javascript:getAccoList(34, 0, 1, '충청남도', '' , 68, 100 )">충청남도</span>
							<ul class="submenu">
								<c:forEach var="area34" items="${area34}">
									<li><a href="javascript:getAccoList(34, ${area34.sigunguCode},1, '${area34.areaName}', '${area34.sigunguName}', ${area34.nx}, ${area34.ny})">${area34.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
						<li class="areaName">
							<span onclick="javascript:getAccoList(35, 0, 1, '경상북도', '' , 89, 91 )">경상북도</span>
							<ul class="submenu">
							<c:forEach var="area35" items="${area35}">
									<li><a href="javascript:getAccoList(35, ${area35.sigunguCode},1, '${area35.areaName}', '${area35.sigunguName}', ${area35.nx}, ${area35.ny})">${area35.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
						<li class="areaName">
							<span onclick="javascript:getAccoList(36, 0, 1, '경상남도', '' , 91, 77 )">경상남도</span>
							<ul class="submenu">
							<c:forEach var="area36" items="${area36}">
									<li><a href="javascript:getAccoList(36, ${area36.sigunguCode},1, '${area36.areaName}', '${area36.sigunguName}', ${area36.nx}, ${area36.ny})">${area36.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
						<li class="areaName">
							<span onclick="javascript:getAccoList(37, 0, 1, '전라북도', '' , 63, 89 )">전라북도</span>
							<ul class="submenu">
							<c:forEach var="area37" items="${area37}">
									<li><a href="javascript:getAccoList(37, ${area37.sigunguCode},1, '${area37.areaName}', '${area37.sigunguName}', ${area37.nx}, ${area37.ny})">${area37.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
						<li class="areaName">
							<span onclick="javascript:getAccoList(38, 0, 1, '전라남도', '' , 51, 67 )">전라남도</span>
							<ul class="submenu">
							<c:forEach var="area38" items="${area38}">
									<li><a href="javascript:getAccoList(38, ${area38.sigunguCode},1, '${area38.areaName}', '${area38.sigunguName}', ${area38.nx}, ${area38.ny})">${area38.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
						<li class="areaName">
							<span onclick="javascript:getAccoList(39, 0, 1, '경상남도', '' , 52, 38 )">제주</span>
							<ul class="submenu">
							<c:forEach var="area39" items="${area39}">
									<li><a href="javascript:getAccoList(39, ${area39.sigunguCode},1, '${area39.areaName}', '${area39.sigunguName}', ${area39.nx}, ${area39.ny})">${area39.sigunguName}</a></li>
								</c:forEach>
							</ul>
						</li>
                    </ul>
    ...
    <!-- 다음페이지로 넘길거 -->
    <form id="viewPage" action="acco_info.jsp" method="POST">
